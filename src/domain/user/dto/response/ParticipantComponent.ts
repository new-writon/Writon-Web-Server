...
export class ParticipantComponent{
    ...
    public static of(challengeOverlapPeriod: number, challengeParticipantCount: number, participantData: Participant[]){
        return new ParticipantComponent(challengeOverlapPeriod, challengeParticipantCount, participantData)
    }
