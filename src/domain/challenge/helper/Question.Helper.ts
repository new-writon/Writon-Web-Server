...
export class QuestionHelper {
  ...
  public async giveBasicQuestionByChallengeId(
    challengeId: number,
  ): Promise<BasicQuestion[]> {
    return this.questionRepository.findBasicQuestionByChallengeId(challengeId);
  }

  public async giveSpecialQuestionByChallengeId(
    challengeId: number,
  ): Promise<SpecialQuestion[]> {
    return this.questionRepository.findSpecialQuestionByChallengeId(
      challengeId,
    );
  }
  ...
  public async giveQuestionsByChallengeId(
    challengeId: number,
  ): Promise<Question[]> {
