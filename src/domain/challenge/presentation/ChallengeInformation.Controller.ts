...
export class ChallengeInformationController {
  ...
  public async bringChallengeAccordingToOrganization() {
    const result =
      await this.challengeInformationService.bringChallengeAccordingToOrganization();
  ...
  public async bringChallengeStatus(
    ...
    const result =
      await this.challengeInformationService.bringChallengeStatus(challengeId);
  ...
  public async bringChallengeDay(
    ...
    const result =
      await this.challengeInformationService.bringChallengeDay(challengeId);
