...
export class UserApi {
  ...
  public async requestUserChallengeWithUserIdAndOragnizationByChallengeId(
    userId: number,
    organization: string,
    challengeId: number,
  ): Promise<UserChallenge> {
    return this.userChallengeHelper.giveUserChallengeWithUserIdAndOragnizationByChallengeId(
      userId,
      organization,
      challengeId,
    );
  ...
  public async requestUpdateUserChallengeReview(
    userId: number,
    organization: string,
    challengeId: number,
  ): Promise<void> {
    return this.userChallengeHelper.executeUpdateUserChallengeReview(
      userId,
      organization,
      challengeId,
    );
  ...
  public async requestUpdateUserChallengeReEngagement(
    userId: number,
    organization: string,
    challengeId: number,
    check: boolean,
  ): Promise<void> {
    return this.userChallengeHelper.executeUpdateUserChallengeReEngagement(
      userId,
      organization,
      challengeId,
      check,
  ...
  public async requestAffiliationByUserIdWithOrganization(
    userId: number,
    organization: string,
  ): Promise<Affiliation> {
    // 검증 0
