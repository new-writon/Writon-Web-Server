...
export class ResponseController {
  ...
  public async checkReEngagement(
    ...
    await this.responseService.checkReEngagement(
      user.userId,
      reEngagementCheck.getOrganization(),
      reEngagementCheck.getChallengeId(),
      reEngagementCheck.getCheck(),
    );
  ...
  public async penetrateObjectiveQuestion(
    ...
    await this.responseService.penetrateObjectiveQuestion(
      user.userId,
      objectiveQuestionAnswer.getOrganization(),
      objectiveQuestionAnswer.getChallengeId(),
      objectiveQuestionAnswer.getSatisfactionAnswer(),
    );
  ...
  public async penetrateSubjectiveQuestion(
    ...
    await this.responseService.penetrateSubjectiveQuestion(
      user.userId,
      subjectiveQuestionAnswer.getOrganization(),
      subjectiveQuestionAnswer.getChallengeId(),
      subjectiveQuestionAnswer.getSatisfactionAnswer(),
    );
