...
export class SmallTalkCommentController {
  ...
  public async bringSmallTalkCommentRead(
    ...
    const result = await this.smallTalkCommentService.bringSmallTalkCommentRead(
      user.userId,
      smallTalkId,
    );
  ...
  public async penetrateSmallTalkComment(
    ...
    await this.smallTalkCommentService.penetrateSmallTalkComment(
      user.userId,
      smallTalkCommentInsert.getSmallTalkId(),
      smallTalkCommentInsert.getOragnization(),
      smallTalkCommentInsert.getSmallTalkComment(),
    );
